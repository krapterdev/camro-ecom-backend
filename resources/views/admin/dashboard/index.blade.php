                ...
                <div class="card card-height-100">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-nowrap table-centered m-0">
                            ...
                            <tbody>
                                <tr>
                                    <td class="ps-3"><a href="#" class="text-muted">larkon/ecommerce.php</a>
                                    </td>
                                    <td>465 </td>
                                    <td><span class="badge badge-soft-success">4.4%</span></td>
                                </tr>
                                <tr>
                                    <td class="ps-3"><a href="#" class="text-muted">larkon/dashboard.php</a>
                                    </td>
                                    <td> 426</td>
                                ...
                                <tr>
                                    <td class="ps-3"><a href="#" class="text-muted">larkon/auth-login.php</a>
                                    </td>
                                    <td> 3369</td>
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>29 April 2024</td>
                                    <td>
                                        <img src="{{ asset('admin_assets/images/products/product-1(1).png')}}"
                                ...
                                <tr>
                                    ...
                                    <td>25 April 2024</td>
                                    <td>
                                        <img src="{{ asset('admin_assets/images/products/product-4.png')}}" alt="product-4"
                                ...
                                <tr>
                                    ...
                                    <td>25 April 2024</td>
                                    <td>
                                        <img src="{{ asset('admin_assets/images/products/product-5.png')}}" lt="product-5"
                                            class="img-fluid avatar-sm">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>21 April 2024</td>
                                    <td>
                                        <img src="{{ asset('admin_assets/images/products/product-6.png')}}" alt="product-6"
                                            class="img-fluid avatar-sm">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>18 April 2024</td>
                                    <td>
                                        <img src="{{ asset('admin_assets/images/products/product-1(2).png')}}"
