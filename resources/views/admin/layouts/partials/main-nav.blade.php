<div class="main-nav">
    ...
    <div class="logo-box">
        <a href="{{ route('second', ['dashboards', 'index']) }}" class="logo-dark">
            <img src="/images/mrlogo.jpg" class="logo-sm" alt="logo sm">
            <img src="/images/mrlogo.jpg" class="logo-lg" alt="logo dark">
        </a>

        <a href="{{ route('second', ['dashboards', 'index']) }}" class="logo-light">
            <img src="/images/mrlogo.jpg" class="logo-sm" alt="logo sm">
            <img src="/images/mrlogo.jpg" class="logo-lg" alt="logo light" style="height: 85px; ">
        </a>
    </div>
        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarCategory">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('third', ['general', 'category', 'create'])}}">Create
                                Category</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('third', ['general', 'category', 'list'])}}">Manage
                                Category</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarProducts">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('third', ['general', 'products', 'create'])}}">Create
                                Product</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('third', ['general', 'products', 'list'])}}">Manage
                                Products</a>
                        </li>
                        <!-- <li class="sub-nav-item">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarOrders">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('third', ['general', 'orders', 'checkout'])}}">Check
                                Out</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarBaseUI">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <!-- <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('third', ['components', 'ui', 'list-group'])}}">List
                                Group</a>
                        </li> -->
                        <!-- <li class="sub-nav-item">
