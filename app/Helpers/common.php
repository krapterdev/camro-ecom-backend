...
function getSqlWithBindings($queryBuilder) {
    $sql = $queryBuilder->toSql();                  // Query with placeholders '?'
    $bindings = $queryBuilder->getBindings();       // Bindings (actual values)

    foreach ($bindings as $binding) {
        // Values ko safely quote kar rahe hain (string ke liye single quotes)
